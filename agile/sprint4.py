import json
# json is a py ibrary which turns py data into a file called json
...
class GradeBook:
    ...
    def display_student_info(self, name: str):
        ...
        data = {
            ...
            "course_catalog": list(self.course_catalog)
        }
    ...
    def load(self, filename="gradebook.json"):
        ...
        # restore catalog
        self.course_catalog = set(data.get("course_catalog", []))
...
# ADDED OPTIONS 12 - 13 for SPRINT 4 SAVE & LOAD FUNCTIONS
    while True:
        print("\n=== Sprint 2 Menu ===")
        print("1) Add course")
